...
def pretifier(theme_name):
    ...
    elif "окружение" in theme_name.lower():
        return "Виртуальное окружение"
    elif "с датой и временем" in theme_name.lower():
        return "Работа с датой и временем"
    elif "работа с файлами" in theme_name.lower():
        return "Работа с файлами"    
    elif "типичных применений" in theme_name.lower():
        return "Табличный формат csv"
    elif "ООП" in theme_name.lower():
        return "ООП в Python"
    return min(result)
