...
def write_to_db(theme_name, section_name, modified_date="Empty", description="Empty", type="list_of_links", url="text"):
    ...
    if html:
        ...
        for section in sections_body_list:
            if section["section_number"] in wasted_letters_numbers:
                ...
                write_to_db(section_name, section_name, modified_date, description, type="text")
