...
slugs = ["", "sozdayem-model-comment", "sozdayem-model-comment", "sozdayem-model-comment", "sozdayem-model-comment", "sozdayem-model-comment", "sozdayem-model-comment", "sozdayem-model-comment", "podnimaem-server-na-digitalocean", "kak-deploit-flask-prilozhenie", "vykladyvaem-telegram-bota-na-server", "avtomatizaciya-deploya-deploy-keys", "avtomatizaciya-deploya-fabric", "migratsii"]
